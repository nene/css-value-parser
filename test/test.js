...
describe("css-property-value-parser", function(){
    describe("parses value", function(){
        var tests = [
            // Dimensions
            ...
            [".3vh", [{type: "dimension", value: 0.3, unit: "vh"}]],
            // Percentages
            ["25%", [{type: "percentage", value: 25}]],
            ["0.51%", [{type: "percentage", value: 0.51}]],
            // Numbers
            ["17", [{type: "number", value: 17}]],
            ["-.26", [{type: "number", value: -0.26}]],
            // Strings
            ["'hello'", [{type: "string", value: "hello"}]],
            ['"world"', [{type: "string", value: 'world'}]],
            ['"with\'quotes"', [{type: "string", value: 'with\'quotes'}]],
            ["'with\"quotes'", [{type: "string", value: "with\"quotes"}]],
            ['"escaped quote: \\" "', [{type: "string", value: 'escaped quote: " '}]],
            ["'escaped quote: \\' '", [{type: "string", value: "escaped quote: ' "}]],
            ['"escaped escape: \\\\ "', [{type: "string", value: 'escaped escape: \\ '}]],
            ["'escaped escape: \\\\ '", [{type: "string", value: "escaped escape: \\ "}]],
            ['"escaped newline: \\\n line"', [{type: "string", value: 'escaped newline: \n line'}]],
            ["'escaped newline: \\\n line'", [{type: "string", value: "escaped newline: \n line"}]],
            // Operators
            [",", [{type: "operator", value: ","}]],
            ["/", [{type: "operator", value: "/"}]],
            ...
            ["calc(5px + 10%)", [{type: "function", name: "calc", params: [
        ...
        tests.forEach(function(item) {
            ...
            it(code, function() {
                expect(parser.parse(code)).to.eql(valueObj);
            });
        });
    });
});
